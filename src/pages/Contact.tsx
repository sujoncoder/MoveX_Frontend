import { IconMapPin, IconPhone, IconMail, IconPhoneCall } from "@tabler/icons-react";
        ...
        <section className="w-full px-6 py-16">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 max-w-5xl mx-auto">
                ...
                <div className="bg-white border border-gray-200 rounded-2xl shadow-sm p-6 flex flex-col items-center text-center hover:shadow-lg transition">
                    <IconMapPin className="w-10 h-10 text-green-600 mb-4" />
                ...
                {/* Call Us */}
                <div className="bg-white border border-gray-200 rounded-2xl shadow-sm p-6 flex flex-col items-center text-center hover:shadow-lg transition">
                    <IconPhone className="w-10 h-10 text-green-600 mb-4" />
                ...
                {/* Mail */}
                <div className="bg-white border border-gray-200 rounded-2xl shadow-sm p-6 flex flex-col items-center text-center hover:shadow-lg transition">
                    <IconMail className="w-10 h-10 text-green-600 mb-4" />
                ...
                {/* Registration */}
                <div className="bg-white border border-gray-200 rounded-2xl shadow-sm p-6 flex flex-col items-center text-center hover:shadow-lg transition">
                    <IconPhoneCall className="w-10 h-10 text-green-600 mb-4" />
