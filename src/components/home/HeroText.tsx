...
import { IconPackage, IconShieldCheckFilled, IconClock, IconArrowNarrowRight } from "@tabler/icons-react";
    ...
    return (
        <section className="relative isolate overflow-hidden flex items-center">
            ...
            <div className="absolute inset-0 -z-10">
                <div className="absolute left-1/2 h-[28rem] w-[28rem] -translate-x-1/2 rounded-full bg-gradient-to-tr from-blue-500/15 via-indigo-500/10 to-purple-500/15 blur-3xl" />
            ...
            {/* Content Grid */}
            <div className="grid w-full max-w-7xl grid-cols-1 items-center gap-12 px-4 py-16 sm:px-6 md:grid-cols-2 lg:gap-20 lg:py-28">
                ...
                >
                    {/* Heading */}
                    <h1 className="text-3xl font-bold tracking-tight text-slate-700 sm:text-5xl lg:text-5xl leading-tight">
                        We Carry Your Trust,
                    ...
                    >
                        ...
                        >
                            Track <IconArrowNarrowRight className="h-4 w-4 sm:h-5 sm:w-5" />
                        </button>
                    </form>
                    ...
                    <div className="mt-10 flex flex-col items-center gap-4 sm:flex-row md:justify-start">
                        <span className="inline-flex items-center gap-2 text-sm sm:text-base text-blue-600">
                            <IconClock className="h-4 w-4 text-blue-500" /> On-time delivery
                        </span>
                        ...
                        <span className="inline-flex items-center gap-2 text-sm sm:text-base text-green-600">
                            <IconShieldCheckFilled className="h-4 w-4 text-green-500" /> Secure payments
                        </span>
                        ...
                        <span className="inline-flex items-center gap-2 text-sm sm:text-base text-purple-600">
                            <IconPackage className="h-4 w-4 text-purple-500" /> Live tracking
                        </span>
                    </div>
                </motion.div>
